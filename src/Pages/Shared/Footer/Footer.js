...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-pink-300 text-black">
                <div>
                    <img className='w-50 h-50' src="https://cdn-icons-png.flaticon.com/128/2327/2327670.png" alt="" />
                    <p>Social Industries Ltd.<br />Providing reliable tech since 1992</p>
                </div>
                <div>
